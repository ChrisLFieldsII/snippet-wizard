        ...
        return (
          <Container p={30}>
            <VStack spacing={8} alignItems={'start'}>
                ...
                <VStack alignItems={'start'}>
                  ...
                  <AlertDescription>
                    <VStack spacing={2} align="start">
                      ...
                      <Text>
                        The PATs are just stored in memory and nowhere else.
                        They are used to make api calls to the respective
                        service. Remember, you can view the{' '}
              ...
              <Text>
                In Snippet Wizard, you can do the following for the many
                different snippet services you require (and we support)...
              </Text>
              ...
              <Text>
                Snippet Wizard is powered by API Plugins that are responsible
                for doing the CRUD operations per service. If a service you
                require is not supported, head over to the{' '}
